                ...
                <div className="rounded-lg bg-white p-4 dark:bg-slate-800">
                    ...
                    <table className="w-full text-black dark:text-slate-100">
                      <tbody>
                        <tr>
                          ...
                          <td className="p-1">{solveId}</td>
                        </tr>
                        <tr>
                          <td className="pr-4">Time:</td>
                          <td
                            className={`flex items-center gap-1 p-1 ${
                              getMinSolveTimeId(sessionSolves) === solveId &&
                        ...
                        {getAverageOfSolveTime(sessionSolves, solveId, 5) && (
                          <tr>
                            <td className="pr-4">Ao5:</td>
                            <td
                              className={`flex items-center gap-1 p-1 ${
                                getMinAverageId(sessionSolves, 5) === solveId &&
                                "text-yellow-600 dark:text-yellow-300"
                              }`}
                            >
                              {getMinAverageId(sessionSolves, 5) ===
                                solveId && <IconCrown size={16} />}
                              <span>
                                {formatTime(
                                  getAverageOfSolveTime(
                                    sessionSolves,
                        ...
                        {getAverageOfSolveTime(sessionSolves, solveId, 12) && (
                          <tr>
                            <td className="pr-4">Ao12:</td>
                            <td
                              className={`flex items-center gap-1 p-1 ${
                                getMinAverageId(sessionSolves, 12) ===
                                  solveId &&
                                "text-yellow-600 dark:text-yellow-300"
                              }`}
                            >
                        ...
                        <tr>
                          ...
                          <td className="py-1">
                            {new Date(solve.times.end).toLocaleString([], {
                              hour12: true,
                            })}
                          </td>
                        </tr>
                        <tr>
                          <td className="pr-4">WCA Event:</td>
                          <td className="py-1">
                            <div>
                              {solve.wcaEvent} (
                              {wcaEvents[solve.wcaEvent].eventName})
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td className="pr-4">Scramble:</td>
                          <td className="py-1">
                          ...
                          <td className="flex gap-1 py-1">
                            <div>
                              <RippleButton
                                ...
                                onClick={() => {
                                  updateSolve(solve.id, "penalty", null);
                                }}
                              >
                                OK
                              </RippleButton>
                  ...
                  <div className="flex justify-end gap-2">
                    <Dialog.Close asChild>
                      <RippleButton
                        onClick={(e) => handleDeleteClick(e.shiftKey)}
